...
/**
 * 
 * OperationJson : Classe du client du serveur Tomcat (Bank) 
...
public class OperationJson {
    ...
    /** OperationJson : Constructeur par default*/
    public OperationJson() {
    	super();
    }

    /** OperationJson : Constructeur avec parametre*/
	public OperationJson(Long id, char op, Float oldBalance, Float valueOp, String dateOp, String type) {
		this.id = id;
		this.op = op;
	...
	/** Getter/Setter de la classe OperationJson*/
	public Long getId() {
		return id;
	}
    ...
    public String toString() {
        return "OperationJson{" + "id=" + id + ", op=" + this.op + ", oldBalance=" 
    ...
    public boolean equals(Object obj) {
        ...
        final OperationJson other = (OperationJson) obj;
