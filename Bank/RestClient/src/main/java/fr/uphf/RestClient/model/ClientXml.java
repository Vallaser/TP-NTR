...
/**
 * 
 * ClientXml : Classe du client du serveur Tomcat (Bank) 
...
public class ClientXml {
	...
	/** ClientXml : Constructeur par default*/
	public ClientXml() {
		super();
	}

	/** ClientXml : Constructeur avec parametre*/
	public ClientXml(Long id, String firstName, String lastName, Float balance, String email, Address address) {
		this.id = id;
	...
	/** Getter/Setter de la classe ClientXml*/
	public Long getId() {
		return id;
	}
    ...
    public boolean equals(Object obj) {
        ...
        final ClientXml other = (ClientXml) obj;
